...
using LLK = MultiSupplierMTPlugin.Providers.Huoshan.LocalizedKey;
...
namespace MultiSupplierMTPlugin.Providers.Huoshan
{
    partial class OptionsForm : Form
    {
        ...
        {
            textBoxAccessKey.Text = _secureSettings.AccessKey;
        ...
        private void BindOptionsChangedEvent()
        {
            ...
            {
                if (
                    _secureSettings.AccessKey != textBoxAccessKey.Text ||
            ...
            textBoxAccessKey.TextChanged += onOptionsChanged;
