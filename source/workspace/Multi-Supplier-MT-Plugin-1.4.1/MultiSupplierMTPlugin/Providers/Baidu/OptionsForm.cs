...
using LLK = MultiSupplierMTPlugin.Providers.Baidu.LocalizedKey;
...
namespace MultiSupplierMTPlugin.Providers.Baidu
{
    partial class OptionsForm : Form
    {
        ...
        private void Localized()
        {
            ...
            labelAppId.Text = LLH.G(LLK.LabelAppId);
            linkLabelAppKey.Text = LLH.G(LLK.LinkLabelAppKey);
        }

        private void LoadOptions()
        {
            textBoxAppId.Text = _secureSettings.AppId;
        ...
        private void BindOptionsChangedEvent()
        {
            ...
            textBoxAppId.TextChanged += onOptionsChanged;
        ...
        private void linkLabelAppKey_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
