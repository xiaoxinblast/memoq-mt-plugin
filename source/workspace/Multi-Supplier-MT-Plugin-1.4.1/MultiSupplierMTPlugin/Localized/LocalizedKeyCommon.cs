namespace MultiSupplierMTPlugin.Localized
{
    ...
    class LocalizedKeyCommon : LocalizedKeyBase
    {
        ...
        [LocalizedValue("cf9c9094-c2e7-4f0e-bd59-56d80ed9f8df", "Expand", "展开")]
        public static LocalizedKeyCommon ButtonExpand { get; private set; }
        ...
        [LocalizedValue("4fba4a9e-9bd3-47d4-b676-ef8207d66be2", "Open the large prompt editor", "打开大提示词编辑器")]
        public static LocalizedKeyCommon ToolTip_OpenLargePromptEditor { get; private set; }
        ...
        [LocalizedValue("b4b97ee9-a92e-4b0b-a618-4f15fc4c8861", "Insert Line Length Limit", "插入最大长度")]
        public static LocalizedKeyCommon TextBoxPromptMenu_LineLengthLimit { get; private set; }

        [LocalizedValue("21f4e30c-9d74-4590-ac0f-4fb5964f1df8", "Insert Character Count", "插入字符数")]
        public static LocalizedKeyCommon TextBoxPromptMenu_CharCount { get; private set; }
