        ...
        public static readonly Dictionary<string, OpenAICompatibleServiceInfo> All = new Dictionary<string, OpenAICompatibleServiceInfo>()
        {
...

            {
                ...
                new OpenAICompatibleServiceInfo()
                {
                    ...
                    ApiDocLink = "https://api-docs.deepseek.com/api/create-chat-completion",
                    Model = "deepseek-v4-flash",
                    BuildInModels = new ModelItem[]
                    {
                        new ModelItem() { UniqueName = "deepseek-v4-flash", DisplayName = "deepseek-v4-flash" },
                        new ModelItem() { UniqueName = "deepseek-v4-pro", DisplayName = "deepseek-v4-pro" },
                        new ModelItem() { UniqueName = "deepseek-chat", DisplayName = "deepseek-chat (deprecated alias)" },
                        new ModelItem() { UniqueName = "deepseek-reasoner", DisplayName = "deepseek-reasoner (deprecated alias)" },
                    }
                }
            },
