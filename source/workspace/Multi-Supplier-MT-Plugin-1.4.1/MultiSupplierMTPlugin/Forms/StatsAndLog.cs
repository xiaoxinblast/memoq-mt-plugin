...
namespace MultiSupplierMTPlugin.Forms
{
    ...
    class StatsAndLogLocalizedKey : LocalizedKeyBase
    {
        ...
        [LocalizedValue("43137df2-0bb8-4f4e-aec2-41a6f4627b9f", "Detailed runtime log", "详细运行日志")]
        public static StatsAndLogLocalizedKey CheckBoxVerboseRuntimeLog { get; private set; }

        [LocalizedValue("cf668e55-0dfe-4640-8a6f-89bb4c7b7141", "API request/response log", "API 请求/响应日志")]
        public static StatsAndLogLocalizedKey CheckBoxApiRequestResponseLog { get; private set; }
        ...
        public static StatsAndLogLocalizedKey CheckBoxVerboseRuntimeLogTip { get; private set; }
        ...
        public static StatsAndLogLocalizedKey CheckBoxApiRequestResponseLogTip { get; private set; }
